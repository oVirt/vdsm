...
def test_status(fake_dmsetup):
    ...
    expected = [
        (
            ...
            " 0 104857600 multipath 2 0 1 0 3 2 E 0 1 1 67:16 F 4 0 E 0 1 1 65:240 A 84 0 E 0 1 1 66:64 A 39 0",  # NOQA: E501 (long line)
        ),
        (
            "3600140543cb8d7510d54f058c7b3f7ec",
            " 0 209715200 multipath 2 0 1 0 3 1 A 0 1 1 65:224 A 0 0 E 0 1 1 65:160 A 0 0 E 0 1 1 66:176 F 1 0",  # NOQA: E501 (long line)
        ),
    ]
