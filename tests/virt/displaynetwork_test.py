...
class TestDisplayNetwork(VdsmTestCase):
    ...
    @mock.patch.object(
        displaynetwork.net_api, 'network_northbound', lambda net: net
    )
    ...
    @mock.patch.object(
        displaynetwork.net_api, 'network_northbound', lambda net: 'eth0'
    )
    ...
    @mock.patch.object(
        displaynetwork.net_api, 'network_northbound', lambda net: None
    )
