...
class DriveXMLTests(XMLTestCase):
    ...
    def check(self, vm_conf, device_conf, xml):
...
class DriveReplicaXML(XMLTestCase):
    ...
    def check(self, vm_conf, device_conf, xml, diskType=DISK_TYPE.FILE):
        drive = Drive(vm_conf, self.log, diskType=diskType, **device_conf)
