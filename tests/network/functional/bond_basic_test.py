...
class TestBondBasic(object):
    def test_add_bond_with_two_nics(self, adapter, switch):
    ...
    def test_add_bond_with_two_nics_and_options(self, adapter, switch):
        with dummy_devices(2) as (nic1, nic2):
            BONDCREATE = {
                BOND_NAME: {
                    'nics': [nic1, nic2],
    ...
    def test_remove_bond(self, adapter, switch):
        with dummy_devices(2) as (nic1, nic2):
            BONDCREATE = {BOND_NAME: {'nics': [nic1, nic2], 'switch': switch}}
    ...
    def test_remove_slaveless_bond(self, adapter, switch):
    ...
    def test_change_bond_slaves(self, adapter, switch):
    ...
    def test_swap_slaves_between_bonds(self, adapter, switch):
        BOND1 = BOND_NAME + '1'
        BOND2 = BOND_NAME + '2'
    ...
    def test_resize_bond(self, adapter, switch):
        with dummy_devices(4) as (nic1, nic2, nic3, nic4):
    ...
    def test_add_bond_with_bad_name_fails(self, adapter, switch):
    ...
    def test_add_bond_with_enforced_mac_address(self, adapter, switch):
        if switch == 'ovs':
            pytest.xfail(
...
class TestBondOptions(object):
    def test_bond_mode_1(self, adapter, switch):
        with dummy_devices(2) as (nic1, nic2):
            BONDCREATE = {
                BOND_NAME: {
                    'nics': [nic1, nic2],
    ...
    def test_bond_active_slave_report(self, adapter, switch):
    ...
    def test_bond_mode_change(self, adapter, switch):
        with dummy_devices(2) as nics:
            BONDCREATE = {
                BOND_NAME: {
                    'nics': nics,
    ...
    def test_bond_options_with_the_mode_specified_last(self, adapter, switch):
        with dummy_devices(2) as (nic1, nic2):
            BONDCREATE = {
                BOND_NAME: {
                    'nics': [nic1, nic2],
    ...
    def test_bond_arp_ip_target_change(self, adapter, switch):
        with dummy_devices(2) as nics:
            create_options = (
    ...
    def test_bond_mode4_caps_aggregator_id(self, adapter, switch):
    ...
    def test_bond_mode0_no_lacp_configuration(self, adapter, switch):
        with two_connected_pair_of_bond_slaves() as (
            bond0_slaves,
            bond1_slaves,
        ):
