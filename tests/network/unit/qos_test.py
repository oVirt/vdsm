...
HOST_QOS_CONFIG1 = {'out': {'ls': {'m1': 4000000,
                                   'd': 100000,
                                   'm2': 3000000},
...
class TestAddDevicesQoSInfo(object):
    ...
    def test_no_qos_on_nic_and_bonded_nets(self):
        nets_info = {NETWORK1_NAME: {'nic': NIC, 'southbound': NIC},
    ...
    def test_non_vlanned_qos_on_nic_and_bonded_nets(self):
        nets_info = {NETWORK1_NAME: {'nic': NIC,
                                     'southbound': NIC,
                                     'hostQos': HOST_QOS_CONFIG1},
                     NETWORK2_NAME: {'bonding': BOND,
                                     'southbound': BOND,
        ...
        expected_devices_info = _create_devices_info_dict(
            bondings={BOND: {
                'qos': [{'hostQos': HOST_QOS_CONFIG2, 'vlan': -1}]}},
            nics={NIC: {
                'qos': [{'hostQos': HOST_QOS_CONFIG1, 'vlan': -1}]}})
    ...
    def test_two_identical_qos_on_same_bond(self):
        nets_info = {NETWORK1_NAME: {'vlan': VLAN1,
                                     'bonding': BOND,
    ...
    def test_vlanned_nets_with_qos(self):
        ...
        expected_devices_info = _create_devices_info_dict(
            vlans=devices_info['vlans'],
            bondings={BOND: {'qos': [{'hostQos': HOST_QOS_CONFIG2,
                             'vlan': VLAN2}
                                     ]
                             }
                      },
            nics={NIC: {'qos': [{'hostQos': HOST_QOS_CONFIG1,
                                 'vlan': VLAN1}
                                ]
                        }
                  }
...
def _create_devices_info_dict(bridges=None, vlans=None,
                              bondings=None, nics=None):
    return {'bridges': bridges or {},
            'vlans': vlans or {},
