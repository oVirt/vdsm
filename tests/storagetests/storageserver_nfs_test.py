...
from storage.storageServer import NFSConnection


def test_extra_options():
    c = NFSConnection("address", version="4.2", extraOptions="extra,options")
...
def test_extra_options_filter_empty():
    c = NFSConnection("address", version="4.2",
...
def test_nfs3_locks_disabled(version):
    c = NFSConnection("address", version=version)
    options = c._mountCon.options.split(",")
...
def test_nfs3_locks_override(version):
    c = NFSConnection("address", version=version, extraOptions="lock")
    options = c._mountCon.options.split(",")
...
def test_nfs3_locks_pass(version):
    c = NFSConnection("address", version=version, extraOptions="nolock")
    options = c._mountCon.options.split(",")
