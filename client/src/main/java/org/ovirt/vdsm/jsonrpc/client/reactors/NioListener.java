 ...
 *
 */
public final class NioListener implements ReactorListener {
    private static Log log = LogFactory.getLog(NioListener.class);
    private final EventListener eventListener;
    private final ServerSocketChannel channel;
    private final Reactor reactor;
    private final Selector selector;

    public NioListener(Reactor reactor, InetSocketAddress address, Selector selector,
    ...
    public ReactorClient accept() {
        ...
        try {
            ...
            this.eventListener.onAcccept(this, client);
