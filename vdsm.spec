...
%if 0%{?centos}
# TODO: require 7.6.0-4+ once available on Centos
Requires: libvirt-daemon-kvm >= 7.6.0-2
%else
# AV 8.5, https://bugzilla.redhat.com/2003644
Requires: libvirt-daemon-kvm >= 7.6.0-4.module+el8.5.0+12786+c4633d9a
%endif
...
%if 0%{?centos}
Requires: qemu-kvm >= 15:6.0.0-28
%else
# AV 8.5 - https://bugzilla.redhat.com/1946084
Requires: qemu-kvm >= 6.0.0-28.module+el8.5.0+12271+fffa967b
%endif
...
Requires:       python3-libvirt >= 3.2.0-3.el7_4.1
%endif
%if 0%{?fedora}
Requires:       python3-decorator
...
%changelog
* Wed Jun 27 2022 Milan Zamazal <mzamazal@redhat.com> - 4.50.2.2
